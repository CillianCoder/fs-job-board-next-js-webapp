...
import { ChevronLeft, MapPin, Briefcase, Calendar, Building2 } from "lucide-react";
    ...
    <div className="bg-gray-50 dark:bg-background min-h-screen pb-20 flex-1">
      ...
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 pt-8 pb-12">
        <div className="container mx-auto px-4">
          <Link href="/jobs" className="inline-flex items-center text-sm font-medium text-foreground/60 hover:text-primary transition-colors mb-8">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-foreground/70 text-sm font-medium">
                  <span className="flex items-center text-primary"><Building2 className="w-4 h-4 mr-2" /> {job.company}</span>
                  <span className="flex items-center"><MapPin className="w-4 h-4 mr-2" /> {job.location}</span>
                  <span className="flex items-center"><Briefcase className="w-4 h-4 mr-2" /> {job.salary}</span>
                  <span className="flex items-center"><Calendar className="w-4 h-4 mr-2" /> Posted {postedDate}</span>
                </div>
              </div>
            </div>
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-8 shadow-sm">
              ...
              <div className="prose dark:prose-invert max-w-none text-foreground/80 space-y-4">
                <p>
                  We are looking for a passionate and experienced <strong>{job.title}</strong> to join our team at {job.company}. 
                  In this role, you will be responsible for building scalable, high-performance applications that serve millions of users.
                </p>
                <p>
                  You will work closely with product managers, designers, and other engineers to deliver impactful features.
                  The ideal candidate has a strong foundation in software engineering, excellent problem-solving skills, and a track record of delivering quality software.
                </p>
                
                <h3 className="text-lg font-semibold mt-6 mb-2 text-foreground">Responsibilities</h3>
                ...
                <h3 className="text-lg font-semibold mt-6 mb-2 text-foreground">Requirements</h3>
                <ul className="list-disc pl-5 space-y-2">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-foreground/60 mb-1">Employment Type</p>
                ...
                <div>
                  <p className="text-sm text-foreground/60 mb-1">Salary Range</p>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
                ...
                <div className="flex flex-wrap gap-2">
                  {job.tags.map((tag, i) => (
                    <span key={i} className="inline-flex items-center rounded bg-gray-100 dark:bg-gray-800 px-3 py-1 text-sm font-medium text-foreground/80">
                      {tag}
                    </span>
                  ))}
                </div>
